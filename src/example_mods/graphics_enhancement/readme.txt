...
'disable_ironhead_black_bars' - Disables the black bars in room 0x1F (the Ironhead arean in the vanilla game). Maybe be useful for mods that use the room for something else.
