...
bin/mods/ogg_music/ogg_music.dll: $(MOD_LOADER_HELPER_OBJECT) src/example_mods/ogg_music/main.c src/example_mods/ogg_music/playlist.c src/example_mods/ogg_music/ram_file.c $(COMMON_PATH)/sprintfMalloc.c
	mkdir -p $(@D)
